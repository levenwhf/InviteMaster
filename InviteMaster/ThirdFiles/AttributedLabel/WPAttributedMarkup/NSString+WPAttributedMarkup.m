...
-(NSAttributedString*)attributedStringWithStyleBook:(NSDictionary*)fontbook
{
    ...
    if ([fontbook objectForKey:NSParagraphStyleAttributeName] != nil)
    {
        [as setAttributes:@{NSParagraphStyleAttributeName:[fontbook objectForKey:NSParagraphStyleAttributeName]} range:NSMakeRange(0, as.length)];
    }
