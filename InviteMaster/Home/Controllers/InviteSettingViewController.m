...
+ (id)newInviteSettingVC
{
    InviteSettingViewController *inviteSettingVC = [[UIStoryboard storyboardWithName:@"Home" bundle:nil] instantiateViewControllerWithIdentifier:@"vcInviteSetting"];
    
    return inviteSettingVC;
}
